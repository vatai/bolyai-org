...
** Virtuális direktóriumok
   ...
   + =/sys= és =/proc= információ a rendszerről a kernelről és a folyamatokról
     ...
     + =/sys/class/thermal/thermal_zone0/temp= CPU vagy alaplap hőmérséklet

* TODO Felhasználók és biztonság 
** sudo

** Vázlat
   + Adminisztráció
     * Felhasználók és jogosultságok
       - Minden felhasználónak van felhasználóneve és egy vagy több csoportba tartozik
     *  Programok
