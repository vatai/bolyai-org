...
**** Szemantika
     ...
     figyelni, hogy a változó név és az ~=~ között ne legyen szünet.)
     
     Amikor használni akarjuk a változó értékét, akkor egy ~$~ jelet
     kell elé tenni.
*** Idézőjelek
    - A szimpla idézőjelek meggátolja a változók behelyettesítését
      mindent úgy ad át ahogy be van írva.
    - A dupla idézőjelek a speciális karaktereket is átadja (pl space)
      de a változókat is behelyettesíti.
**** $PATH változó
     - A $PATH változóban van azoknak a direktóriumok listája
       melyben található programok bárhonnan elérhetőek.
